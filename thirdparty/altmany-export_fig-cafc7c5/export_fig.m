    ...
    try
        ...
        if isbitmap(options)
            ...
            if options.png
                ...
                if ismac;  system(['open -a Preview ' options.name '.png']);  elseif ispc;  winopen([options.name '.png']); end
                s = dir([options.name '.png']); fprintf('%g kB\n',s.bytes/1E3)
            end
            if options.bmp
            ...
            if options.jpg
                ...
                if ismac;  system(['open -a Preview ' options.name '.jpg']);  elseif ispc;  winopen([options.name '.jpg']); end
                s = dir([options.name '.jpg']); fprintf('%g kB\n',s.bytes/1E3)
            end
